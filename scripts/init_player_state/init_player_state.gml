function init_player_input() {
	...
	if gamepad_is_connected(gamepad_id) {
		...
		actionkey =  gamepad_button_check_pressed(gamepad_id ,gp_shoulderrb) || gamepad_button_check_pressed(gamepad_id ,gp_shoulderr); // mouse_check_button(mb_left) ||
		possesskey = gamepad_button_check_pressed(gamepad_id, gp_shoulderl) || gamepad_button_check_pressed(gamepad_id, gp_shoulderlb); // keyboard_check_pressed(vk_space) || 
